...
public class SimpleZestView {
   ...
   String filePath = "/Users/ericperez/workspaceCSCI4980/workspaceCSCI4980Perez/SimpleZestEricPerez1023/src/input-data-zest-1023.txt";
...
//      node4 = new GraphNode(graph, SWT.NONE, "Node4");
      ...
      for (String iName : listNodeNames) {
         // TODO: Class Exercise -> fill in here
...
//      graphConnection.setLineWidth(3);
      ...
      for (String[] iConn : readConnectionInfo) {
         // TODO: Class Exercise
          new GraphConnection(graph, SWT.NONE, mapGraphNode.get(iConn[0]), mapGraphNode.get(iConn[1]));
      }
   }

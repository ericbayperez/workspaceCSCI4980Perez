...
public class GModelBuilder {
   private static final String filePath = "/Users/ericperez/workspaceCSCI4980/workspaceCSCI4980Perez/simpleZestProject3-classex/src/input-graph-info.txt";
   ...
   public GModelBuilder buildByGraphInfoFile() {
      ...
      for (String[] iConn : connectionInfo) {
         ...
         //TODO: Class Exercise
         nodeSrc.getConnectedTo().add(nodeDst);
